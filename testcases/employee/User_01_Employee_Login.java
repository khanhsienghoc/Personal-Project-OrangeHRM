...
public class User_01_Employee_Login extends BaseTest {
    ...
    public void Login_01_Employee_ValidUsername_And_InvalidPassword(){
        log.info("Login_01_Employee_ValidUsername_And_InvalidPassword - Step_01 - Input valid username");
        loginPage.inputToTextBoxByText(driver,"Username", Common_Employee_Login.username );

        log.info("Login_01_Employee_ValidUsername_And_InvalidPassword - Step_ 02 - Input invalid password");
        loginPage.inputToTextBoxByText(driver,"Password", invalidPassword);

        log.info("Login_01_Employee_ValidUsername_And_InvalidPassword - Step_ 03 - Click Login");
        loginPage.clickToLoginButton();

        log.info("Login_01_Employee_ValidUsername_And_InvalidPassword - Step_03 - Verify the '"+GlobalConstants.INVALID_CREDENTIALS_MESSAGE+ "' error message displays");
    ...
    public void Login_02_Employee_InvalidUsername_And_ValidPassword(){
        log.info("Login_02_Employee_InvalidUsername_And_ValidPassword - Step_01 - Input invalid username");
        loginPage.inputToTextBoxByText(driver,"Username", invalidUsername);

        log.info("Login_02_Employee_InvalidUsername_And_ValidPassword - Step_02 - Input valid password");
        loginPage.inputToTextBoxByText(driver,"Password", Common_Employee_Login.password );

        log.info("Login_02_Employee_InvalidUsername_And_ValidPassword - Step_03 - Click Login");
        loginPage.clickToLoginButton();

        log.info("Login_02_Employee_InvalidUsername_And_ValidPassword - Step_03 - Verify the '"+GlobalConstants.INVALID_CREDENTIALS_MESSAGE+ "' error message displays");
        Assertions.assertEquals(GlobalConstants.INVALID_CREDENTIALS_MESSAGE, loginPage.getErrorText());
    }
    ...
    public void Login_03_Employee_InvalidUsername_And_InvalidPassword(){
        log.info("Login_03_Employee_InvalidUsername_And_InvalidPassword - Step_01 - Input invalid username");
        loginPage.inputToTextBoxByText(driver,"Username", invalidUsername);

        log.info("Login_03_Employee_InvalidUsername_And_InvalidPassword - Step_02 - Input invalid password");
        loginPage.inputToTextBoxByText(driver,"Password", invalidPassword);

        log.info("Login_03_Employee_InvalidUsername_And_InvalidPassword - Step_03 - Click Login");
        loginPage.clickToLoginButton();

        log.info("Login_03_Employee_InvalidUsername_And_InvalidPassword - Step_03 - Verify the '"+GlobalConstants.INVALID_CREDENTIALS_MESSAGE+ "' error message displays");
        Assertions.assertEquals(GlobalConstants.INVALID_CREDENTIALS_MESSAGE, loginPage.getErrorText());
    }
    ...
    public void Login_04_Employee_ValidCredentials(){
        log.info("Login_04_Employee_ValidCredentials - Step_01 - Input valid username");
        loginPage.inputToTextBoxByText(driver,"Username", Common_Employee_Login.username);

        log.info("Login_04_Employee_ValidCredentials - Step_02 - Input valid password");
        loginPage.inputToTextBoxByText(driver,"Password", Common_Employee_Login.password);
    ...
    public void Login_05_Employee_VerifyTabDisplayed(){
        log.info("Login_05_Employee_VerifyTabDisplayed - Step_01 - Verify the 'Leave' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"Leave"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_02 - Verify the 'Time' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"Time"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_03 - Verify the 'My Info' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"My Info"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_04 - Verify the 'Performance' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"Performance"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_05 - Verify the 'Dashboard' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"Dashboard"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_06 - Verify the 'Directory' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"Directory"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_07 - Verify the 'Claim' tab show");
        Assertions.assertTrue(homePage.isMenuTabDislaysByText(driver,"Claim"));

        log.info("Login_05_Employee_VerifyTabDisplayed - Step_08 - Verify the 'Buzz' tab show");
    ...
    public void Login_06_Employee_VerifyTabUndisplayed(){
        log.info("Login_06_Employee_VerifyTabUndisplayed - Step_01 - Verify the 'PIM' undisplayed");
        Assertions.assertTrue(homePage.getListMenuTabSize(driver,"PIM") < 1);

        log.info("Login_06_Employee_VerifyTabUndisplayed - Step_01 - Verify the 'Recruitment' undisplayed");
